...
genres = data_dict(crsr.fetchall(), "genres_data", ["typename", "intro_text", "abbrev", "icon"])
...
for curr_genre in genres:
  ...
  works[curr_genre_abbrev] = data_dict(crsr.fetchall(), "works_data", ["id", "year", "period", "cust", "name", "desc", "filename"])
